...
class LoginWindow(QMainWindow):
	...
	def go_to_register_page(self):
		webbrowser.open('http://ec2-35-87-197-79.us-west-2.compute.amazonaws.com:8000/register/')

	# Login function that manages the token authentication
	def login(self):
		try:
			url = 'http://ec2-35-87-197-79.us-west-2.compute.amazonaws.com:8000/api/get_auth_token/'
